package com.fcascan.pokeplaymat.presentation.ui.theme.stadium
...
@Composable
private fun ColorPaletteLightPreview() {
...
@Preview(showBackground = true, widthDp = 1250)
@Composable
private fun ColorPaletteLightMediumContrastPreview() {
    val colorList = listOf(
...
@Preview(showBackground = true, widthDp = 1250)
@Composable
private fun ColorPaletteLightHighContrastPreview() {
    val colorList = listOf(
...
@Preview(showBackground = true, widthDp = 1250)
@Composable
private fun ColorPaletteDarkMediumContrastPreview() {
    val colorList = listOf(
...
@Preview(showBackground = true, widthDp = 1250)
@Composable
private fun ColorPaletteDarkHighContrastPreview() {
    val colorList = listOf(
